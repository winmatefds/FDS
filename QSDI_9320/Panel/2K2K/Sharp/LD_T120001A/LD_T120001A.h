...
#define LED_BACK_LIGHT 0 // 1 // LED Back Light need to set AB_SWAP_CD
...
ROM gmt_PanelData Panel_2K2K_LD_T120001A =
{
	...
	STPANEL_LVDS_MAP_JEIDA,			// WORD W_LVDSSignalMap
