...
ROM gmt_IrProtocolExt IrProtocol = {    
    ...
    0x2E39,//Vic+ 0x2039,											// Timing register (IR_TIMEBASE_MEASURESTEP)
    ...
    2,												// Num Packets
    {
    	...
    	//
    	{
    		...
    		(88 - BIT_TOLERANCE*2),					// Start0 Min
    		(88 + BIT_TOLERANCE*2),					// Start0 Max
    		(44 - BIT_TOLERANCE*2),					// Start1 Min
    		(44 + BIT_TOLERANCE*2),					// Start1 Max
		...
		//
		{
			...
			(88 - BIT_TOLERANCE*2),					// Start0 Min
			(88 + BIT_TOLERANCE*2),					// Start0 Max
			(22 - BIT_TOLERANCE*2),					// Start1 Min
			(22 + BIT_TOLERANCE*2),					// Start1 Max
			(NOMINAL_TROUGH - BIT_TOLERANCE),		// Through Min
			(NOMINAL_TROUGH + BIT_TOLERANCE),		// Through Max
			(NOMINAL_LOGIC0 - BIT_TOLERANCE),		// Logic0 Min
			(NOMINAL_LOGIC0 + BIT_TOLERANCE), 		// Logic0 Max
