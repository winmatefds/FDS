...
//******************************************************************************
#define DECOMPRESS_PATCH
#ifdef DECOMPRESS_PATCH
WORD huge gm_GmcaCycleDecompressPatch(BYTE far *Bp_Src, BYTE near *Bp_Dest, WORD (far *LoadFunc)(BYTE near *Bp_Src, WORD W_Size));
#endif
