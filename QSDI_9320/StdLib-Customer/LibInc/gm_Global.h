...
typedef unsigned long   gmt_DP_DPCP_ADDR;
typedef unsigned long   gmt_DPRX_SDP_ADDR;
...
// macroses-replacement of gm_InterruptEnable/Disable functions
#define InterruptEnable(W_BitPattern) gm_SetRegBitsWord(MISC_OCMMASK, W_BitPattern);/*enable  interrupt source*/
#define InterruptDisable(W_BitPattern) gm_ClearRegBitsWord(MISC_OCMMASK, W_BitPattern);/*disable interrupt source*/
