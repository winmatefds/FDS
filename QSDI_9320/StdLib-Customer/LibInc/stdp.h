...
#define MAX_NUM_PAYLOADS		16			// Max supported by HW
...
typedef enum
{
	DP_HardwareMapping_0,
	DP_HardwareMapping_1,
	DP_HardwareMapping_2,
	DP_HardwareMapping_3
	
}DP_HardwareMapping_t;

typedef enum
{
	STDP_3D_NO_VSC_FORMAT,
	STDP_3D_FORMAT_UNKNOWN,
	STDP_3D_NON_STEREO_VIDEO,
	...
	STDP_3D_FORMAT_INTERLEAVED_VERTICAL,
	STDP_3D_FORMAT_SBS_RHALF_RIGHT,
	STDP_3D_FORMAT_SBS_RHALF_LEFT,
	STDP_3D_FORMAT_END_FORMAT = STDP_3D_FORMAT_SBS_RHALF_LEFT,
} STDP_3DFormat_t;
...
typedef void far (* DP_Ext_Sha1Input_t)(const U8 DP_RAM * Bp_Message, U16 W_Length);
...
#define CommonPortStructureEntries							\
		...
		DP_HardwareMapping_t	HardwareMapping;			\
		U32						NextListItem;				\
...
typedef struct
{
	...
	DP_MsaVideoMode_t				MsaVideoMode_e;//Added 7/16/10
