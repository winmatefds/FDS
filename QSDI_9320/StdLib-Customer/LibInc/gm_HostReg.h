...
//******************************************************************************
#define gm_ReadRegByteFar(DW_RegBase, W_RegOffs) \
    (*((BYTE far volatile*)(DW_RegBase) + (WORD)(W_RegOffs)))

#define gm_WriteRegByteFar(DW_RegBase, W_RegOffs, B_RegValue) \
    (*((BYTE far volatile*)(DW_RegBase) + (WORD)(W_RegOffs)) = (BYTE)(B_RegValue))
...
//---DWord access - Write functions---
#define gmRegDW(RegAddr) (*(volatile DWORD hostreg*const)(RegAddr))

#define gm_WriteRegDWord(DW_RegAddr, DW_RegValue)  \
   (*(volatile DWORD hostreg*)(DW_RegAddr) = (DWORD)(DW_RegValue))   
...
#define gm_ReadRegDWord(DW_RegAddr) (*(volatile DWORD hostreg*)(DW_RegAddr))
...
#define gm_SetRegBitsDWord(DW_RegAddr, DW_Set) \
      ((*(volatile DWORD hostreg*)(DW_RegAddr)) |= ((DWORD)(DW_Set)))           

#define gm_ClearRegBitsDWord(DW_RegAddr, DW_Clear) \
      ((*(volatile DWORD hostreg*)(DW_RegAddr)) &= (~((DWORD)(DW_Clear))))         

#define gm_ClearAndSetBitsDWord(DW_RegAddr, DW_Clear, DW_Set) \
   ((*(volatile DWORD hostreg*)(DW_RegAddr)) = (((*(volatile DWORD hostreg*)(DW_RegAddr)) \
      & (~((DWORD)(DW_Clear))))) | ((DWORD)(DW_Set)))  
#endif
