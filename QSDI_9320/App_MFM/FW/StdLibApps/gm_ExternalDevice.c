...
BYTE ADV7180_ByteRead(BYTE Address)
{
   BYTE Data;
   BYTE Addr = Address;
...
#ifdef TVP5160_DEV_ID
      return ((dev_TVP5160GetVideoStatus(VDD_1) == D_LOCKED)
              && (dev_TVP5160GetVideoMode(VDD_1) == VDD_MODE_NOVIDEO));
#endif
*/
//gm_Printf("ADV7180_ByteRead(0x10)=%x",ADV7180_ByteRead(0x10));
if( (ADV7180_ByteRead(0x10) ==0x4d) || (ADV7180_ByteRead(0x10) ==0x0d))
	return TRUE;
else
	return (FALSE);
