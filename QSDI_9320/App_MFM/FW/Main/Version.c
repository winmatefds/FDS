...
ROM char ApplicationName[] = "STDP93xx ST_4K2K_93xx_BOARD Board";
#endif
...
ROM char ExtFirmwareVersion[MaxFirmwareVersionSize+1] = "1.1 RC1";

ROM char DateTime[] = "Aug. 15, 2013 4:30 PM";
