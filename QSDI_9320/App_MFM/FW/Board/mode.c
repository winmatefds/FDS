...
ROM StandardModeStruct  CompHD_ModeTable[] =
{
   ...
   {  // 18 *** 1152iLH    - 1920 x  1080 x 50I ***
      312, 50,       // StdHFreq, DeltaHFreq, (in 100Hz unit)
      500, 50,       // StdVFreq, DeltaVFreq, (in 1/10Hz unit)
      626, 10,       // StdVTotal, DeltaVTotal, (in line unit)
      2376,          // StdHTotal,
      1920, 540,     // StdWidth, StdHeight,
...
ROM StandardModeStruct StandardModeTable_60[] =
{
   ...
   {  // 7 *** 1920 x 1080 x 60 Hz - 148.5MHz ***
   ...
   {  // 12 *** 1680 x 1050 x 60 Hz Reduce Blanking ***
   ...
   {  // 13 *** 1400 x 1050 x 60 Hz Reduce Blanking ***
      647,10,     // StdHFreq, (in 100Hz unit)
      600, 10,    // StdVFreq, (in 1/10Hz unit)
      1080, 4,    // StdVTotal, (in line unit)
      1560,       // StdHTotal,
...
*/
   {  // 23 *** 1600 x 900 x 60 Hz Reduce ***
      ...
      2128,       // StdHTotal,
      1600, 900,           // StdWidth, StdHeight,
      232 + 80, 25 + 6,    // StdHBackPorch, StdVBackPorch,
      5,                   // StdVSyncWidth (for overlapped mode)
      gmd_MODE_GRAPHICS,   // ModeType,
      0,    // ExtCheck
   },

   {  // 24 *** 1280 x 800 x 60 Hz ***
   ...
   {  // 29 *** 1360 x 768 x 60 Hz ***
      477, 10,     // StdHFreq, (in 100Hz unit)
      600, 10,
      795,  3,      // StdVTotal, (in line unit)
      1648,       // StdHTotal,
      1280, 768,           // StdWidth, StdHeight,
      256,  18,  // StdHBackPorch, StdVBackPorch,
      145,                   // StdHSyncWidth (for overlapped mode)
      gmd_MODE_GRAPHICS,            // ModeType,
      0,   // ExtCheck
   },

   {  // 30 *** 1280 x 768 x 60 Hz - Reduced ***
...
*/
   ...
   {                       // *** 25: Std 4 - 720 x 480 x 60 Hz ***
	  357, 10,              // StdHFreq, DeltaHFreq, (in 100Hz unit)
	  597, 10,              // StdVFreq, DeltaVFreq, (in 1/10Hz unit)
	  613, 4,               // StdVTotal, DeltaVTotal, (in line unit)
	  1088,                  // StdHTotal,
	  896, 576,             // StdWidth, StdHeight,
	  141, 32,              // StdHStart, StdVStart,
	  0,							// StdHpulse (used only in VideoOverlapped)
	  gmd_MODE_GRAPHICS,	// ModeType,
	  0,
	},
...
/*
        {                       // *** : 1920 x 540 x 60Hz ***
          ...
          600, 10,              // StdVFreq, DeltaVFreq, (in 1/10Hz unit)
          540+45, 20,              // StdVTotal, DeltaVTotal, (in line unit)
          1920+280,                 // StdHTotal,
          1920, 540,               // StdWidth, StdHeight,
          88+44, 5+4,              // StdHStart, StdVStart,
          gmd_MODE_GRAPHICS,                                   // StdHpulse (used only in VideoOverlapped)
          0                // ModeType
        },
	  */
/*
   {  // 37 *** 848 x 480 x 60 Hz ***
...
ROM StandardModeStruct StandardModeTable_70[] =
{
   ...
   {  // 9 *** 1600 x 1000 x 75 Hz ***
      783, 10,                    // StdHFreq, (in 100Hz unit)
      748, 10,
      1047, 4,                    // StdVTotal, (in line unit)
      2160,                   // StdHTotal,
      1600, 1000,                // StdWidth, StdHeight,
      168 + 112, 6 + 3,                // StdHBackPorch, StdVBackPorch,
      0,                // StdHSyncWidth, StdVSyncWidth,
      gmd_MODE_GRAPHICS,                  // ModeType,
      0,                // ExtCheck
   },

   {  // 10 *** 1280 x 1024 x 72 Hz ***
   ...
   {  // 20 *** 1024 x 768 x 75 Hz ***
      601, 10,               					// StdHFreq, (in 100Hz unit)
      749, 10,
      802,  1,              					// StdVTotal, (in line unit)
      1360,                 				// StdHTotal,
      1024, 768,            				// StdWidth, StdHeight,
   ...
   {  // 30 *** 640 x 480 x 72 Hz ***
      378, 10,                             // StdHFreq, (in 100Hz unit)
      720, 10,
      520,  4,                           // StdVTotal, (in line unit)
      832,                             // StdHTotal,
      640, 480,                        // StdWidth, StdHeight,
      128 + 40, 28 + 3,                         // StdHBackPorch, StdVBackPorch,
      0,                         // StdHSyncWidth, StdVSyncWidth,
      gmd_MODE_GRAPHICS | gmd_MODE_NEG_HSYNC | gmd_MODE_NEG_VSYNC,      // ModeType,
      0,                   // ExtCheck
   },

   {  // 31 *** 848 x 480 x 72 Hz ***
   ...
   {  // 33 *** 640 x 480 x 75 Hz ***
      375, 10,                             // StdHFreq, (in 100Hz unit)
      750, 10,
      500,  4,                           // StdVTotal, (in line unit)
      840,                             // StdHTotal,
      640, 480,                        // StdWidth, StdHeight,
      120 + 64, 16 + 3,                         // StdHBackPorch, StdVBackPorch,
      0,                         // StdHSyncWidth, StdVSyncWidth,
      gmd_MODE_GRAPHICS,      // ModeType,
      0,          // ExtCheck
   },

   {  // 34 *** 640 x 480 x 66 Hz ***
      350, 10,                             // StdHFreq, (in 100Hz unit)
      667, 10,
      525,  4,                           // StdVTotal, (in line unit)
      864,                             // StdHTotal,
      640, 480,                        // StdWidth, StdHeight,
      96 + 64, 39 + 3,                          // StdHBackPorch, StdVBackPorch,
      0,                         // StdHSyncWidth, StdVSyncWidth,
      gmd_MODE_GRAPHICS,                     // ModeType,
      0,                   // ExtCheck
   },

   {  // 35 *** 848 x 480 x 70 Hz ***
      350, 10,                             // StdHFreq, (in 100Hz unit)
      700, 10,
      500,  4,                           // StdVTotal, (in line unit)
      1072,                            // StdHTotal,
...
{
   {
      // 0 *** 1680 x 1050 x 120 Hz RB ***
      1334, 10,            // StdHFreq, (in 100Hz unit)
      1200,  10,            // StdVFreq, (in 1/10Hz unit)
      1112,  5,            // StdVTotal, (in line unit)
      1840,                // StdHTotal,
      1680, 1050,          // StdWidth, StdHeight,
   ...
   {
      // 1 *** 1856 x 1392 x 75 Hz *** 288MHz
      // 1 *** 1920 x 1440 x 75 Hz *** 297MHz
   ...
   {  // 2 *** 1920 x 1200 x 85 Hz *** 281.25MHz
   ...
   {  // 4 *** 1600 x 1200 x 85 Hz *** 229.5MHz
      1062, 10,            // StdHFreq, (in 100Hz unit)
      850,  10,            // StdVFreq, (in 1/10Hz unit)
      1250,  4,            // StdVTotal, (in line unit)
      2160,                // StdHTotal,
   ...
   {  // 5 *** 2560 x 1600 x 60 Hz *** 348.5MHz
   ...
   {  // 6 *** 2560 x 1600 x 60 Hz Reduce *** 268.5MHz
   ...
   {  // 7 *** 2048 x 1536 x 60 Hz *** 267.25MHz
   ...
   {  // 8 *** 2048 x 1536 x 60 Hz Reduce *** 209.25MHz
   ...
   {  // 9 *** 1680 x 1050 x 85 Hz *** 214.75MHz
      939, 10,             // StdHFreq, (in 100Hz unit)
      850, 10,             // StdVFreq, (in 1/10Hz unit)
      1105, 4,             // StdVTotal, (in line unit)
      2288,                // StdHTotal,
   ...
   {  // 11 *** 1800 x 1440 x 60 Hz *** 218.25MHz
   ...
   {  // 12 *** 2560 x 1440 x 60 Hz *** 241.5MHz
      888, 10,             // StdHFreq, (in 100Hz unit)
      600, 10,             // StdVFreq, (in 1/10Hz unit)
      1481, 4,             // StdVTotal, (in line unit)
      2720,                // StdHTotal,
   ...
   {  // 13 *** 1856 x 1392 x 60 Hz *** 218.25MHz
...
*/
   ...
   {                       // *** NTSC -  720 x  240 x 60I ***
      ...
      262, 4,               // StdVTotal, DeltaVTotal, (in line unit)
      858,                  // StdHTotal,
      676, 222,   			// StdWidth, StdHeight,
      29, 29,                // StdHStart, StdVStart
      0,					// StdHpulse (used only in VideoOverlapped)
      gmd_MODE_SDVIDEO | gmd_MODE_INTERLACED,		// ModeType
      0,			 	// Overlap Type
   },
   {                       // *** PAL  -  720 x  288 x 50I ***
      ...
      312, 4,             	// StdVTotal, DeltaVTotal, (in line unit)
      864,                  // StdHTotal,
      674, 258,             // StdWidth, StdHeight,
      25, 36,                // StdHStart, StdVStart,
      0,					// StdHpulse (used only in VideoOverlapped)
      gmd_MODE_SDVIDEO | gmd_MODE_INTERLACED,		// ModeType
      0,				// Overlap Type
   },
