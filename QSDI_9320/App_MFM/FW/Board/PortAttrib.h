...
#define	IsGraphicInput(x)               ((x)==ALL_BOARDS_VGA1 || (x)==ALL_BOARDS_HDMI || (x)==ALL_BOARDS_HDMI2 || (x)==ALL_BOARDS_HDMI3 ||(x)==ALL_BOARDS_DVI1 ||(x)==ALL_BOARDS_DVI2 || (x)==ALL_BOARDS_DP1 ||(x)==ALL_BOARDS_DP2 || (x)==ALL_BOARDS_DP3 ) // HDMI2 is DVI, and set DP as Graphic Input
