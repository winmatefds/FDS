...
gmt_HdmiDviProperties ROM gmc_HDMI_DVIProps[NUM_OF_HDMIDVI_INP] =
{
   ...
   {AID_PHY12, DID_DVI_DUAL, NULL_PTR,  "STDDVIRX_1", NULL_PTR, NULL_PTR},	//Dual DVI
#else
...
gmt_DipProperties ROM gmc_DIPProps[] =
{
   ...
   {DIP_PORTA,DIP_8_BIT,DIP_LSB_MSB,DIP_BGR_UYV,DIP_IPCLK1,DIP_EMBEDDED_SYNC,{DIP_A1, NONE, NONE}}, //vpc3230--601
...
{DIP1,     6, DIPX,            SIG_DIPX,      EXTERNAL, DIP,      (void*)&gmc_DIPProps[0]},
{DIP1,     6, DIPX,            SIG_DIPX,      EXTERNAL, DIP,      (void*)&gmc_DIPProps[0]},
...
/*
   ...
   {DIP1,     6, DIPX,            SIG_DIPX,      EXTERNAL, DIP,      (void*)&gmc_DIPProps[1]},
#elif ((DEFAULT_DIP_DAUGHTER_BOARD_OUT == ANX9021_RGB444) || (DEFAULT_DIP_DAUGHTER_BOARD_OUT == ANX9021_YCbCr444))
 {DIP1,     6, DIPX,            SIG_DIPX,      EXTERNAL, DIP,      (void*)&gmc_DIPProps[2]},
#elif (DEFAULT_DIP_DAUGHTER_BOARD_OUT == ANX9021_YCbCr422)
   {DIP1,     6, DIPX,            SIG_DIPX,      EXTERNAL, DIP,      (void*)&gmc_DIPProps[3]},
#else
 {NOT_USED, 0, NONE,            NONE,          NONE,     NONE,     NONE},
#endif */
{DIP1,     6, DIPX,            SIG_DIPX,      EXTERNAL, DIP,      (void*)&gmc_DIPProps[1]},
#else
...
#if (FEATURE_DISPLAY_PORT == ENABLE) && (NUM_OF_CNTR_ON_CPHY0 != 0)
