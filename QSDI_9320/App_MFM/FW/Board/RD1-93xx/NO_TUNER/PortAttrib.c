...
StandardModeStruct ROM * ROM LocalVGAModeTable_60[] = {StandardModeTable_60, StandardModeTable_70, 0};
StandardModeStruct ROM * ROM LocalVGAModeTable_75[] = {StandardModeTable_70, StandardModeTable_85, 0};
...
PortAttrib ROM AppPortAttrib[NUM_MASTER_LIST] =
{
   //ALL_BOARDS_CVBS1 // 0
   {
      ...
      ExternalDeviceInit,                            // usage & extensions to configure external devices
      0,                                                                       // input color space (DUMMY)
      gmt_DecoderStatus,//gmt_ExternalStatus,                                                                   // type of input measurement needed (DUMMY)
   ...
   //ALL_BOARDS_COMP1 // 2
   {
      ...
      ExternalDeviceInit,       // usage & extensions to configure external devices (DUMMY)
      0,                         // input color space
   ...
   //ALL_BOARDS_DIP1 //6
   {
      ...
      AUTO_MUTE_ENABLE,                                       // auto display muting
        gmd_SYNC_ODD_TYPE_EXT,	       // input capture sync alignment
      0,                            // usage & extensions to configure external devices
      0,                                                                       // input color space (DUMMY)
      gmt_IFMmeasurement,//gmt_ExternalStatus,                                                                   // type of input measurement needed (DUMMY)
      LocalExtDecoderModeTable,                       // mode table for selection
      SlaveExtDecoderModeTable,                       // alternative selection
      0,                                                                       // power handler policy regarding the input status (DUMMY)
      0,                                                                       // power handler policy regarding the actions (DUMMY)
